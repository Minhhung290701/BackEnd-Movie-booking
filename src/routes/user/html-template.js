...
exports.booingTicketSuccess = (ticketId, filmSchedule) => {
     ...
     <td align="center" valign="top" style="padding:0;Margin:0;width:560px"> 
      <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="border-collapse:collapse;border-spacing:0px"> 
        ...
        <tr> 
         ...
         <br><span style="font-size: 18px; color:#000000">Mã đặt vé: ${ticketId}</span> 
         ...
         <br><span style="font-size: 18px; color:#000000">Số ghế: ${filmSchedule.seats.toString()}</span>
      </p></td> 
      </tbody></table>`
